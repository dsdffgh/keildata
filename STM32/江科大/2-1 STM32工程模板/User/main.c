...
int main(void)
{
	...
	// delay_ms(1000);		 // 延时1s
	// delay_ms(1000);		 // 延时1s
	OLED_ShowString(1, 7, "Speed:", 5); 
	//OLED_ShowString(1, 1, "Sm", 2); 
	//OLED_ShowString(1, 2, "pm", 2); 
	//OLED_ShowString(8, 4, "dm", 2); 
	//OLED_ShowString(8, 4, "km", 2); 
	...
	while (1)
	{
		...
		OLED_ShowString(7, 1, "gyro", 4); 
		OLED_ShowString(70, 1, "acc", 3); 
		OLED_Float(2, 1, gyro_X,1);
		OLED_Float(3, 1, gyro_Y,1);
		OLED_Float(4, 1, gyro_Z,1);
		OLED_Float(2, 66, acc_X, 1);
		OLED_Float(3, 66, acc_Y, 1);
		OLED_Float(4, 66, acc_Z, 1);
		Speed = Encoder_Get(2);
		OLED_Float(7, 50, Speed, 2);
	}
}
